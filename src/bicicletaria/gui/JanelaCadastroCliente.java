...
public class JanelaCadastroCliente extends javax.swing.JFrame {
    ...
    private void jInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jInserirActionPerformed
        ...
        cliente.setUf(jCEstado.getSelectedItem().toString());
    ...
    private void jExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jExcluirActionPerformed
        if(JOptionPane.showConfirmDialog(this, "Deseja excluir esse registro?") == 0) {
            controladorCliente.excluir(jCPF.getText());
        }
        limparCampos();
        criarTabela();
    ...
    private void jEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jEditarActionPerformed
        ...
        c.setCpf(jCPF.getText());
        c.setDatanascimento(jData.getText());
        c.setBairro(jBairro.getText());
        c.setEndereco(jEndereco.getText());
        c.setCep(jCep.getText());
        c.setTelefone(jTelefone.getText());
        c.setCelular(jCelular.getText());
        c.setEmail(jEmail.getText());
        c.setCidade(jCidade.getText());
        c.setUf(jCEstado.getSelectedItem().toString());
        controladorCliente.editar(c);
        limparCampos();
        criarTabela(); 
    ...
    public void limparCampos(){
     ...
     public void criarTabela(){
        ...
        cliente = controladorCliente.listaCliente();
        for (Cliente c : cliente) {
            modeloTabela.addRow(new Object[]{c.getNome(), c.getEndereco(), c.getBairro(),
                c.getCidade(), c.getCep(), c.getTelefone(), c.getCelular(), c.getUf(), c.getCpf(),
                c.getDatanascimento(), c.getEmail()});
        }
     }
