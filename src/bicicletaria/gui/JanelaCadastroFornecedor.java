...
import bicicletaria.negocio.ControladorFornecedor;
...
public class JanelaCadastroFornecedor extends javax.swing.JFrame {
    ...
    private static ControladorFornecedor controladorFornecedor = new ControladorFornecedor();
    ...
    private void initComponents() {
        ...
        modeloTabela.addColumn("Razão Social");
    ...
    private void jBInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBInserirActionPerformed
        ...
        fornecedor.setCpfcnpj(jTCnpj.getText());
        ...
        fornecedor.setUf(jCEstado.getSelectedItem().toString());
        controladorFornecedor.inserir(fornecedor);
        JOptionPane.showMessageDialog(this, controladorFornecedor.getMensagem());
        criarTabela();
        limparCampos();
    ...
    private void jBEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEditarActionPerformed
        ...
        f.setCpfcnpj(jTCnpj.getText());
        jTCnpj.setVisible(false);
        ...
        f.setUf(jCEstado.getSelectedItem().toString());
        controladorFornecedor.editar(f);
        limparCampos();
        criarTabela();
    ...
    private void jBExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBExcluirActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Deseja excluir esse registro?") == 0){
            controladorFornecedor.excluir(cpf);
        }
        limparCampos();
        criarTabela();
        //listarCliente();
    ...
    public void criarTabela(){
        ...
        fornecedores = controladorFornecedor.listaFornecedor();
        for (Fornecedor f : fornecedores) {
            modeloTabela.addRow(new Object[]{f.getRazaosocial(), f.getCpfcnpj(), f.getRg(),
                f.getNome(), f.getTelefone(), f.getEmail(), f.getEndereco(), f.getCep(),
                f.getBairro(), f.getCidade(), f.getUf()});
        }
    } 
